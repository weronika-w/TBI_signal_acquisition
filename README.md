...
- Arduino_ADS is a C++ code that runs the Arduino. It allows for communication with ADS124S08 and ADS1299 to receive channel specific data, runs the amperometric electrode interrogation and sends the data to MATLAB. This code is still being validated during hardware testing;
- Arduino_ADS_simulation.m is a C++ code that was the code for data transmission and amperometric electrode interrogation used for pre-hardware implementation testing. It uses a simulated ADC data to check logic of the interrogation routine and data transmission. 
