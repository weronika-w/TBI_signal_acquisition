...
- Arduino_ADS_simulation.m is a C++ code for data transmission and amperometric electrode interrogation used for pre-hardware implementation testing. It uses a simulated ADC data to check logic of the interrogation routine and data transmission. 
